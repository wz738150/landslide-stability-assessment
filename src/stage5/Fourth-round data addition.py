...
# 文件路径（直接用你的路径）
path_active = r"E:\Paper\lw6\python_code\Active_learnning\stage2\SSAP_all2.csv"
path_ssap = r"E:\Paper\lw6\python_code\Active_learnning\stage5\SSAP_Features4.csv"
# 读取两个CSV
